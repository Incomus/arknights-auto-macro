...
#time.sleep(0.5)
os.system("taskkill /f /im internet_appers.exe")
...
w = ark.action_start('4G LTE', 1367, 958, 276, 76)
time.sleep(1)
pyautogui.click(x=913, y=221)
time.sleep(.5)
w.minimize_window()
print('internet_started')
